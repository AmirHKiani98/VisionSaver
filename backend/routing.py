...
from cronjob.consumers import ProgressConsumer, CounterProgressConsumer, CounterModifiedProgressConsumer, ActualCounterProgressConsumer, DownloadingResultsProgress, CheckingCameraProgress
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/checking_camera/(?P<version>\w+\d+)/$", CheckingCameraProgress.as_asgi()),
]